...
<html>
	<head>
		<title>Millennial School | Change Password</title>
			...
			<div id="section">
				...
				<div class="content">
					...
					<div class="lbox1">	
						...
						{
							$sql="select * from staff where password='{$_POST["opass"]}' and ID='{$_SESSION["ID"]}'";
							$result=$db->query($sql);
								if($result->num_rows>0)
								{
									if($_POST["npass"]==$_POST["cpass"])
									{
										$sql="UPDATE staff SET  password='{$_POST["npass"]}' where  ID='{$_SESSION["ID"]}'";
										$db->query($sql);
