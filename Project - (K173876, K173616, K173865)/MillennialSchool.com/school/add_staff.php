...
<html>
	<head>
		<title>Millennial School | Add Staff</title>
			...
			<div id="section">
				...
				<div class="content1">
					...
					<?php
						...
						{
							$sq="INSERT INTO staff (TNAME,TPASS,QUAL,SAL)
								SELECT * FROM (SELECT '{$_POST["sname"]}',1234,'{$_POST["qual"]}','{$_POST["sal"]}') AS tmp
								WHERE NOT EXISTS (
								    SELECT TNAME,QUAL FROM staff WHERE TNAME = '{$_POST["sname"]}' and QUAL = '{$_POST["qual"]}'
									) LIMIT 1";
							if($db->query($sq))
							{
